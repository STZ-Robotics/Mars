     ...
     */
    public interface StatusColorCode {
        ...
        /**
         * Gets the message template associated with this status code.
         * This template can be used to format specific error details when creating an ActionStatus.
         * @return The message template as a string.
         */
