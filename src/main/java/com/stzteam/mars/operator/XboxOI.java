...
/**
 * A concrete implementation of the {@link ControllerOI} for Xbox controllers.
 * This class wraps a WPILib {@link CommandXboxController} and maps its specific 
 * hardware inputs (A, B, X, Y, LB, etc.) to the universal MARS positional records.
 */
public class XboxOI implements ControllerOI {
    ...
    /**
     * Initializes the Xbox controller mapping.
     *
